...
def write_grayscale(filename, pixels):
    ...
    Args:
        ...
        pixels: A rectangular images stored as a sequence of rows.
    ...
    with open(filename, 'wb') as bmp:
        ...
        size_bookmark = bmp.tell()      #The next four bytes hold the filesize as a 32-bitmap
        ...
        pixel_offset_bookmark = bmp.tell() # The next four bytes hols the integer offset
        ...
        bmp.write(_int32_to_bytes(width)) # Image width in pixel_offset_bookmark
    ...
    # Color palette - linear grayscale
    for c in range(256):
